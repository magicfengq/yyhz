			...
			<div class="myCenter_content bgec">
				<div class="myCenter_content_c card_details bgff" style="margin-top: 10px;">
					<ul class="message_list">
						<li class="clearfix">
							<span class="float-left">策划项目</span>
						...
						<li class="clearfix">
							<span class="float-left">通告类型</span>
							<span class="float-right font-grey">${announceInfo['publicType']}</span>
						</li>
						<li class="clearfix">
							<span class="float-left">具体详情</span>
							<span class="float-right font-grey">${announceInfo['note']}</span>
						</li>
						<li class="clearfix">

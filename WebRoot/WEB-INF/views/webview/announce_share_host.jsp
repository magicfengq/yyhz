			...
			<div class="myCenter_content bgec">
				<div class="myCenter_content_c card_details bgff" style="margin-top: 10px;">
					<ul class="message_list">
						<li class="clearfix">
							<span class="float-left">活动主题</span>
							<span class="float-right font-grey">${announceInfo['title']}</span>
						</li>
						<li class="clearfix">
							<span class="float-left">艺人类型</span>
							<span class="float-right font-grey">${announceInfo['name']}</span>
						</li>
						<li class="clearfix">
							<span class="float-left">活动时间</span>
							<span class="float-right font-grey">${announceInfo['showTime']}</span>
						</li>
						<li class="clearfix">
							<span class="float-left">活动城市</span>
							<span class="float-right font-grey">${announceInfo['city']}</span>
						</li>
						<li class="clearfix">
							<span class="float-left">性别要求</span>
							<span class="float-right font-grey">
								<c:choose>
									<c:when test="${announceInfo['sex'] == 1}">男</c:when>
									<c:otherwise>女</c:otherwise>
								</c:choose>
							</span>
						</li>
						<li class="clearfix">
							<span class="float-left">活动地址</span>
							<span class="float-right font-grey">${announceInfo['address']}</span>
						</li>
						<li class="clearfix">
							<span class="float-left">酬金</span>

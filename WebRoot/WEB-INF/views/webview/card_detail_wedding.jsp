...
<html>
	...
	<div class="model-info-box clearfix" style="background-color: #D494B6;">
		<!--主题风格-->
		...
		<div class="myCenter_content_c card_details" style="padding: 0;">
			<ul class="pic_list model-pic-list">
				...
				<ul class="message_list" style="padding: 0 16px;">
					<li class="clearfix">
						<span class="float-left">内容介绍</span>
						<span class="float-right">${cardDetail['cardInfo']['details']}</span>
					</li>
					<li class="clearfix">
						<span class="float-left">机构组成</span>
	...
	<!--点击图片放大end-->	<script src="resource/webview/js/web-view-bridge.js"></script>
	<script>
		//图片放大
		mui.previewImage();

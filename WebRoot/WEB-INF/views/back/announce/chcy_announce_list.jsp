...
<body>
	<div style="width:100%;height:100%">
		<table id="dg" class="easyui-datagrid" style="width:100%;height:100%"
			data-options="url:'back/announceInfoAjaxPage.do?type=3', iconCls:'icon-save', 
			rownumbers:true, pagination:true, singleSelect:true, 
			toolbar:'#toolbar'">
			<thead>
				<tr>
					<th data-options="field:'title',align:'center',sortable:false" style="width: 15%;">策划项目</th>
...
<script type="text/javascript">
	...
	function edit(id){
		window.parent.addTabPanel('通告：演绎/庆典','back/announceDetail.do?type=3&id=' +id);
	}
	function del(id) {

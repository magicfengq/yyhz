...
<div class="easyui-layout" data-options="fit:true">
	<div data-options="region:'west'" style="width:300px; padding: 10px">
		...
		<form id="fm" name="fm" method="post" action="back/announceInfoAjaxSave.do">
			...
			<div class="fitem">
				<label>需要装备:</label>
				<input id="titleLabel" name="title" style="width: 200px" class="easyui-textbox" value="${info.title }" readonly="readonly" data-options="required:true,validType:'length[1,100]'"/>
			</div>
			<div class="fitem">
				<label>使用时间:</label>
				<input id="showTimeLabel" name="showTime" style="width: 200px" class="easyui-datebox" readonly="readonly" value="<fmt:formatDate value="${info.showTime}" pattern="yyyy-MM-dd"/>"/>
			</div>
			<div class="fitem">
				<label>使用城市:</label>
			...
			<div class="fitem">
				<label>注意事项:</label>
				<input id="noteLabel" name="note" style="width: 200px" class="easyui-textbox" readonly="readonly" value="${info.note }"/>
			</div>
			<div class="fitem">
				<label>预算:</label>
			...
			<div class="fitem">
				<label style="vertical-align: top;">装备详单:</label>
				<textarea id="detailLabel" name="detail" style="width: 200px;height:50px;resize:none;" class="easyui-textarea">${info.detail }</textarea>
			</div>
			
			<div class="fitem">
				<label>发布类型:</label>
				<input id="publicTypeLabel" name="publicType" style="width: 200px" class="easyui-textbox" value="${info.publicTypeNames }" readonly="readonly" />
			</div>

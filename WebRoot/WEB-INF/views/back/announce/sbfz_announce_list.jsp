...
<body>
	<div style="width:100%;height:100%">
		<table id="dg" class="easyui-datagrid" style="width:100%;height:100%"
			data-options="url:'back/announceInfoAjaxPage.do?type=2', iconCls:'icon-save', 
			rownumbers:true, pagination:true, singleSelect:true, 
			toolbar:'#toolbar'">
			<thead>
				<tr>
					<th data-options="field:'title',align:'center',sortable:false" style="width: 10%;">需要设备</th>
					<th data-options="field:'city',align:'center',sortable:true" style="width: 10%;">使用城市</th>
...
<script type="text/javascript">
	...
	function edit(id){
		window.parent.addTabPanel('通告：设备/服装','back/announceDetail.do?type=2&id=' +id);
	}
	function del(id) {

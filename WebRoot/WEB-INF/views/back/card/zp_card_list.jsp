...
<body>
	<div style="width:100%;height:100%">
		<table id="dg" class="easyui-datagrid" style="width:100%;height:100%"
			data-options="url:'back/cardInfoAjaxPage.do?type=7', iconCls:'icon-save', 
...
<script type="text/javascript">
	...
	function edit(id){
		window.parent.addTabPanel('作品','back/cardListDetail.do?type=7&id=' +id);
	}
	function del(id) {

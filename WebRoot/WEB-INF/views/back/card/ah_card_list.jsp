...
<body>
	<div style="width:100%;height:100%">
		<table id="dg" class="easyui-datagrid" style="width:100%;height:100%"
			data-options="url:'back/cardInfoAjaxPage.do?type=6', iconCls:'icon-save', 
...
<script type="text/javascript">
	...
	function edit(id){
		window.parent.addTabPanel('爱好','back/cardListDetail.do?type=6&id=' +id);
	}
	function del(id) {

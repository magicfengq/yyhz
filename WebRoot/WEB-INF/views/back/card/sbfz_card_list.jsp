...
<body>
	<div style="width:100%;height:100%">
		<table id="dg" class="easyui-datagrid" style="width:100%;height:100%"
			data-options="url:'back/cardInfoAjaxPage.do?type=2', iconCls:'icon-save', 
			rownumbers:true, pagination:true, singleSelect:true, 
			toolbar:'#toolbar'">
			<thead>
				<tr>
					<th data-options="field:'cardName',align:'center',sortable:true" style="width: 20%;">名称</th>
					<th data-options="field:'detailRole',align:'center',sortable:true" style="width: 15%;">用途</th>

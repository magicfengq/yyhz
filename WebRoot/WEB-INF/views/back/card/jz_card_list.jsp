		...
		<table id="dg" class="easyui-datagrid" style="width:100%;height:100%"
			...
			<thead>
				<tr>
					...
					<th data-options="field:'detailRole',align:'center',sortable:false" style="width: 10%;">专业具体名称</th>
...
<script type="text/javascript">
	...
	function edit(id){
		window.parent.addTabPanel('兼职','back/cardListDetail.do?type=3&id=' +id);
	}
	function del(id) {

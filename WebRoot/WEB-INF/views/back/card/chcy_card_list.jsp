...
<body>
	<div style="width:100%;height:100%">
		<table id="dg" class="easyui-datagrid" style="width:100%;height:100%"
			data-options="url:'back/cardInfoAjaxPage.do?type=3', iconCls:'icon-save', 
			rownumbers:true, pagination:true, singleSelect:true, 
			toolbar:'#toolbar'">
			<thead>
				<tr>
					<th data-options="field:'cardName',align:'center',sortable:true" style="width: 15%;">主题</th>
					<th data-options="field:'details',align:'center',sortable:true" style="width: 20%;">内容介绍</th>
	...
	function edit(id){
		window.parent.addTabPanel('策划/创意','back/cardListDetail.do?type=3&id=' +id);
	}
	function del(id) {

...
<body>
	<div style="width:100%;height:100%">
		<table id="dg" class="easyui-datagrid" style="width:100%;height:100%"
			data-options="url:'back/cardInfoAjaxPage.do?type=8', iconCls:'icon-save', 
			rownumbers:true, pagination:true, singleSelect:true, 
			toolbar:'#toolbar'">
			<thead>
				<tr>
					<th data-options="field:'cardName',align:'center',sortable:true" style="width: 15%;">姓名/艺名</th>
...
<script type="text/javascript">
	...
	function edit(id){
		window.parent.addTabPanel('公益','back/cardListDetail.do?type=8&id=' +id);
	}
	function del(id) {

package com.yyhz.rong.example.message;

import com.yyhz.rong.RongCloud;
import com.yyhz.rong.messages.CustomTxtMessage;
...
import com.yyhz.rong.methods.message.chatroom.Chatroom;
import com.yyhz.rong.methods.message.discussion.Discussion;
import com.yyhz.rong.methods.message.group.Group;
import com.yyhz.rong.methods.message.history.History;
import com.yyhz.rong.methods.message.system.MsgSystem;
import com.yyhz.rong.models.message.*;
import com.yyhz.rong.models.response.HistoryMessageResult;
...
public class MessageExample {
     ...
     * 此处替换成您的appKey
     * */
    private static final String appKey = "25wehl3u29fsw";
    /**
     * 此处替换成您的appSecret
     * */
    private static final String appSecret = "bfb0X3V2hl1rK5";
    ...
    public static void main(String[] args) throws Exception {
         ...
         *
         */
        String[] targetIds = {"4d3fc1af883a4583b6f41f884ae497fb"};

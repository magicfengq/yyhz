package com.yyhz.utils.stream.config;
...
public class Configurations {
	...
	public static String getDownloadFileUrlPrefix() {
		return getConfig("DOWNLOAD_FILE_URL_PREFIX");
	}

	public static String buildDownloadUrl(String relativeUrl) {
		return StringUtils.prependIfMissing(relativeUrl, getDownloadFileUrlPrefix(), "http", "https");
	}
}

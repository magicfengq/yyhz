...
public class DateFormatUtil {
		...
		try {
			for (String key : dateRegFormat.keySet()) {
				if (Pattern.compile(key).matcher(dateStr).matches()) {
					...
					} else if (key.equals("^\\d{4}-\\d{1}-\\d{1}$")) {
						dateStr = StringUtils.join(StringUtils.split(dateStr),"0");	
					}
	...
	public static void main(String[] args) {
		String[] dateStrArray = new String[] { "2017-11-2","2017-3-12","2017-3-2","2014-03-12 12:05:34", "2014-03-12 12:05", "2014-03-12 12", "2014-03-12",
